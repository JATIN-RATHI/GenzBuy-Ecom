...
function calculateLimit(type, max = 7) {
  ...
  if (PERCENTAGE_REGEX.test(type)) {
    const groups = (_a2 = type.match(PERCENTAGE_REGEX)) == null ? void 0 : _a2.groups;
...
function obscureHeaders(config) {
  var _a2, _b;
  if ((_a2 = config == null ? void 0 : config.headers) == null ? void 0 : _a2["Authorization"]) {
    const token = `...${config.headers["Authorization"].toString().substr(-5)}`;
    config.headers["Authorization"] = `Bearer ${token}`;
  }
  if ((_b = config == null ? void 0 : config.headers) == null ? void 0 : _b["X-Contentful-Resource-Resolution"]) {
...
function errorHandler(errorResponse) {
  ...
  if (data && typeof data === "object") {
    ...
    errorName = (_a2 = data.sys) == null ? void 0 : _a2.id;
  }
...
var getTimelinePreviewParams = (params) => {
  ...
  const timelinePreview = (_a2 = params === null || params === void 0 ? void 0 : params.timelinePreview) !== null && _a2 !== void 0 ? _a2 : (_b = params === null || params === void 0 ? void 0 : params.alphaFeatures) === null || _b === void 0 ? void 0 : _b.timelinePreview;
...
// node_modules/contentful/dist/esm/utils/normalize-cursor-pagination-parameters.js
...
// node_modules/contentful/dist/esm/utils/normalize-cursor-pagination-response.js
