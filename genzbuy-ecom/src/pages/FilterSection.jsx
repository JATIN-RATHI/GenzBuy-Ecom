...
import '../pages/FilterSection.css';
...
function FilterSection() {
  ...
  const visibleCategories = showAllCategories ? FilterData.categories : FilterData.categories.slice(0, 5);
  ...
  return (
    ...
    <div className="container2">
      ...
      <h2 className="title">Filters</h2>
        ...
        {/* Fit */}
        <div className="filter-group">
          <h3 className="catHead">Choose your Type</h3>
          <ul>
